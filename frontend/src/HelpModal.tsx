    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Кнопка «Виды» сохраняет и восстанавливает рабочее представление таблицы: видимые колонки, их порядок и ширины, сортировку, фильтры и быстрый статус метаданных. Строка интерактивного поиска намеренно не входит в вид.',
          'Доступны готовые виды DJ, Метаданные, Технический и Компактный. Можно сохранить собственный вид, затем применить его, обновить текущими настройками или удалить.',
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'The Views control saves and restores a table workspace: visible columns, order and widths, sorting, filters and the quick metadata-status filter. The interactive search query is intentionally not part of a view.',
          'Built-in DJ, Metadata, Technical and Compact views are available. You can also save a custom view, apply it later, update it from the current settings or delete it.',
