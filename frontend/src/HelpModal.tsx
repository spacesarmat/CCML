    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Панель «Пресеты» быстро переключает готовую конфигурацию таблицы: видимые колонки, их порядок, ширины и сортировку.',
          'Доступны пресеты DJ, Метаданные, Технический и Компактный. Пресеты не меняют интерактивный поиск, фильтры Stage 13 или быстрый статус метаданных.',
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'The Presets bar quickly switches a ready-made table configuration: visible columns, order, widths and sorting.',
          'DJ, Metadata, Technical and Compact presets are available. Presets do not change interactive search, Stage 13 filters or the quick metadata-status filter.',
