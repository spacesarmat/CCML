...
function DuplicateGroupsView({
  ...
  const copy = language === 'ru'
    ? {
        ...
        verifyAudioHint: 'FFmpeg декодирует файлы в низкочастотный mono PCM и сравнивает форму сигнала вместе с грубым спектральным профилем. Similar также требует разницу полной длительности не более 60 секунд. Это дополнительная эвристика, а не доказательство идентичности.',
    ...
    : {
        ...
        verifyAudioHint: 'FFmpeg decodes files to low-rate mono PCM and compares waveform features together with a coarse spectral profile. Similar also requires the full-duration difference to stay within 60 seconds. This is an additional heuristic, not proof of identity.',
