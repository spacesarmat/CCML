export namespace model {
	...
	export class DJMixSavedPlan {
	    ...
	    static createFrom(source: any = {}) {
	        return new DJMixSavedPlan(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.scopeTrackIds = source["scopeTrackIds"];
	        this.options = this.convertValues(source["options"], DJMixPlanOptions);
	        this.plan = this.convertValues(source["plan"], DJMixPlan);
	        this.createdAt = source["createdAt"];
	        this.updatedAt = source["updatedAt"];
	    }
